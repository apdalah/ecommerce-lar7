...
<html class="loading" lang="en" data-textdirection="rtl">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('public/Dashboard/vendors/css/forms/icheck/icheck.css') }}" />
        <link rel="stylesheet" type="text/css" href="{{ asset('public/Dashboard/vendors/css/forms/icheck/custom.css') }}" />
        <!-- END VENDOR CSS-->
        <!-- BEGIN MODERN CSS-->
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('public/Dashboard/css-rtl/pages/login-register.css') }}" />
        <!-- END Page Level CSS-->
        <!-- BEGIN Custom CSS-->
    ...
    <body class="vertical-layout vertical-menu 1-column menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu" data-col="1-column">
        ...
        <script src="{{ asset('public/Dashboard/vendors/js/forms/validation/jqBootstrapValidation.js') }}" type="text/javascript"></script>
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN MODERN JS-->
        ...
        <!-- END MODERN JS-->
        <!-- BEGIN PAGE LEVEL JS-->
        <script src="{{ asset('public/Dashboard/js/scripts/forms/form-login-register.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL JS-->
