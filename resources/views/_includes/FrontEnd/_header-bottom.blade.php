                        ...
                        <div class="box-content block_content">
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    <li class="item parent">
                                        <a href="#" title="Laptops &amp; Accessories">
                                            <i
                                                ...
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/laptop.png') no-repeat scroll center center;
                                                "
                                            >
                                            </i>
                                            Laptops &amp; Accessories
                                    ...
                                    <li class="item parent group">
                                        <a href="#" title="Electronics">
                                            <i
                                                class="hasicon nov-icon"
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/Electronic.png') no-repeat scroll center center;
                                                "
                                            >
                                            </i>
                                            Electronics
                                    ...
                                    <li class="item parent group">
                                        <a href="#" title="Audio &amp; Sound Devices">
                                            <i
                                                class="hasicon nov-icon"
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/audio-sound.png') no-repeat scroll center
                                                        center;
                                                "
                                            >
                                            </i>
                                        ...
                                        <span class="show-sub fa-active-sub"></span>
                                        <span class="menu-sub-title">Speaker, Headphone, Soundcard ...</span>
                                        <div class="dropdown-menu" style="width: 922px;">
                                            <ul>
                                    ...
                                    <li class="item parent group">
                                        <a href="#" title="Smartphone &amp; Tablets">
                                            <i
                                                class="hasicon nov-icon"
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/tablet.png') no-repeat scroll center center;
                                                "
                                            >
                                            </i>
                                            Smartphone &amp; Tablets
                                        ...
                                        <span class="show-sub fa-active-sub"></span>
                                        <span class="menu-sub-title">Iphone, OPPO, SamSung, SONY ...</span>
                                        <div class="dropdown-menu" style="width: 922px;">
                                            <ul>
                                    ...
                                    <li class="item">
                                        ...
                                        <span class="menu-sub-title">Mouse, Headphone, Console ...</span>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Smart Watches ">
                                            <i
                                                class="hasicon nov-icon"
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/smart-watch.png') no-repeat scroll center
                                                        center;
                                                "
                                            ></i>
                                            Smart Watches
                                    ...
                                    <li class="item">
                                        <a href="#" title="Camera">
                                            <i
                                                class="hasicon nov-icon"
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/camera.png') no-repeat scroll center center;
                                                "
                                            ></i>
                                            Camera
                                        </a>
                                    ...
                                    <li class="item">
                                        <a href="#" title="Monitor &amp; Television">
                                            <i
                                                class="hasicon nov-icon"
                                                style="
                                                    background: url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/monitor.png') no-repeat scroll center center;
                                                "
                                            ></i>
                                            Monitor &amp; Television
                                        </a>
                                                            ...
                                                            <li class="item col-md-3 mw-40 html">
                                                                <div class="menu-content">
                                                                    <div class="menu-banner-3 text-center">
                                                                        <a href="#"><img class="img-fluid" src="http://images.vinovathemes.com/prestashop_savemart/mega-menu-3.jpg" alt="mega-menu-3.jpg" /></a>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                                ...
                                                                <div class="menu-content">
                                                                    <div class="row">
                                                                        <div class="col-12 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#"><img class="img-fluid" src="http://images.vinovathemes.com/prestashop_savemart/banner-mega-1.jpg" alt="menu-banner-1" /></a>
                                                                        </div>
                                                                        <div class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#"><img class="img-fluid" src="http://images.vinovathemes.com/prestashop_savemart/banner-mega-2.jpg" alt="menu-banner-2" /></a>
                                                                        </div>
                                                                        <div class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#"><img class="img-fluid" src="http://images.vinovathemes.com/prestashop_savemart/banner-mega-3.jpg" alt="menu-banner-3" /></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
