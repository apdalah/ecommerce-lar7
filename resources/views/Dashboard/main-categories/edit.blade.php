...
@section('title')
    @lang('msgs.edit') @lang('msgs.category')
@endsection
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('msgs.edit') @lang('msgs.category')</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">@lang('msgs.edit') @lang('msgs.category')</h4>
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('admin.main-categories.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                        <img src="{{ $mainCategory-> image }}" alt="@lang('msgs.category')" style="width:200px;height:80px;">
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value='{{ $mainCategory->name }}' id="name" class="form-control" placeholder="@lang('msgs.insert') @lang('msgs.category') @lang('msgs.' . $lang->abbr)" name="category[{{ $index }}][name]" />
