        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">تعديل اللغه</li>
                </ol>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $language->abbr }}" id="abbr" class="form-control" placeholder="ادخل اختصار اللغة     " name="abbr" />
                                                @error('abbr')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mt-1">
                                                <input type="checkbox" name="status" id="switcheryColor4" class="switchery" data-color="success" {{$language->status == 1 ? 'checked' : ''}} />
